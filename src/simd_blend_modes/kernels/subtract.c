...
static __m128 subtract_comp_ps128(__m128 in_c, __m128 layer_c)
{
    return _mm_sub_ps(_mm_mul_ps(in_c, _mm_set1_ps(255.0f)), layer_c);
}

static __m256 subtract_comp_ps256(__m256 in_c, __m256 layer_c)
{
...
{
    return blend_ratio_mode_simd(args, subtract_comp, subtract_comp_ps128,
                                 subtract_comp_ps256, 1);
}
