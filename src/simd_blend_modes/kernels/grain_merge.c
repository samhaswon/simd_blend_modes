...
static inline float grain_merge_comp(float in_c, float layer_c)
{
    return clamp01(in_c + layer_c - 0.5f);
}

static inline __m128 grain_merge_comp_ps128(__m128 in_c, __m128 layer_c)
{
...
static inline __m256 grain_merge_comp_ps256(__m256 in_c, __m256 layer_c)
{
