...
static inline rgb_triplet lch_chroma_comp(rgb_triplet bg, rgb_triplet fg)
{
    return lch_blend_triplet(bg, fg, 0, 1, 0);
}

#if SIMD_BLEND_MODES_X86
static inline void lch_chroma_comp_ps128(__m128 bg_r, __m128 bg_g, __m128 bg_b,
...
PyObject *blend_lch_chroma(PyObject *self, PyObject *args)
{
    ...
    return blend_rgb_mode_simd(
        args,
        lch_chroma_comp,
        SIMD_BLEND_MODES_RGB_SIMD_ARGS(lch_chroma_comp_ps128, lch_chroma_comp_ps256)
    );
}
