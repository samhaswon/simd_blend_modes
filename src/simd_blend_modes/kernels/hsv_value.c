...
static inline rgb_triplet hsv_value_comp(rgb_triplet bg, rgb_triplet fg)
{
...
static inline void hsv_value_comp_ps128(__m128 bg_r, __m128 bg_g, __m128 bg_b,
                                        ...
                                        __m128 *out_r, __m128 *out_g, __m128 *out_b)
{
    ...
    hsv_to_rgb_ps128(bg_h, bg_s, fg_v, out_r, out_g, out_b);
}

static inline void hsv_value_comp_ps256(__m256 bg_r, __m256 bg_g, __m256 bg_b,
                                        ...
                                        __m256 *out_r, __m256 *out_g, __m256 *out_b)
{
    ...
    hsv_to_rgb_ps256(bg_h, bg_s, fg_v, out_r, out_g, out_b);
}
#endif
...
PyObject *blend_hsv_value(PyObject *self, PyObject *args)
{
    ...
    return blend_rgb_mode_simd(
        args,
        hsv_value_comp,
        SIMD_BLEND_MODES_RGB_SIMD_ARGS(hsv_value_comp_ps128, hsv_value_comp_ps256)
    );
}
